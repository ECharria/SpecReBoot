...
def main():
    ...
    p.add_argument("--candidate-node-attrs", nargs="+", default=["shared name"])
    ...
    df_mean_sim = pd.read_csv(args.mean_sim_csv, index_col=0)
    df_edge_sup = pd.read_csv(args.edge_sup_csv, index_col=0)
